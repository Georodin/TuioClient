...
- a `TUIO 1.1 Debug Tokens` root with UI images and labels for token IDs `1..24`
...
- Choose the debug token IDs individually in the adapter Inspector using the compact `1..24` checkbox grid.
